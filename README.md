...
To run the whole app with your own cloud backend (for testing), you should create your own project (web-app) on [Google Firebase](https://firebase.google.com/) and you'll be provided with application credentials, which you should paste into the file `src/config/firebaseConfig`:
...
`translations` - an array of available translations. Used for generating links to each translation.
