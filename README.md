...
heading: {
 ...
 meta: {
    translations: { ru: { name: "russian" }, es: { name:"spanish" } },
    created: { userId, userName, time },
    updated: { userId, userName, time }
 }
```
...
`translations` - all avaliable for the material languages. In other words, info about all added before translations.
