...
3) Завершение запланированных работ по веб-платформе. Это ещё $5k (из расчёта $1k за месяц работы).

4) Контент. Исходя из предпочтений пользователей мы будем добавлять аудиокниги, подкасты и другие доступные материалы.

5) SMM, создание и распространение информации о нас,  активный поиск партнеров - в университетах, школах, диаспорах, на языковых форумах.
